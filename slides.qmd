...
![](img/g2d_network_bifurcation.gif){fig-align="center" width="94%"}

::: {.smaller}
TVBO/tvboptim Desikan-Killiany node trajectories in $(I_{\mathrm{eff}}, V)$ space, overlaid on the continuation map
:::
