...
FIG_DIR = os.path.join("..", "..", "img", "figures", "spring")
os.makedirs(FIG_DIR, exist_ok=True)

def save_animation_video(ani, stem, fps=30):
    output_stem = os.path.join(FIG_DIR, stem)
...
![](../../img/figures/spring/spring_single.gif)
...
![](../../img/figures/spring/spring_ics.gif)
...
fig.savefig(os.path.join(FIG_DIR, 'phase_space.png'), dpi=500, bbox_inches='tight')
```
...
![](../../img/figures/spring/spring_mass.gif)
...
![](../../img/figures/spring/spring_realism.gif)