# 6. Parameter Exploration & Inference {background-color="#6880af"}
...
::: {.column width="55%"}
::: {.incremental}
- Same idea as the bifurcation diagrams from [Bifurcation Analysis](#ch-bifurcation)
...
1. **[Bifurcation map](#ch-bifurcation)** → pick a *regime* of interest
...
- [Open notebook](notebooks/4_I_fMRI_BOLD_FC.html){target="_blank"}
:::
:::
...
- [Open notebook](notebooks/4_II_MEG_Peak_Frequency.html){target="_blank"}
:::
:::
::::
